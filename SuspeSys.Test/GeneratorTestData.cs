    ...
    public class GeneratorTestData
    {
        ...
        public void GeneratorEmployeeInfo()
        {
            ...
            for (var index = 0; index < 5; index++)
            {
                ...
                employee.Code = string.Format("00" + index.ToString());
            ...
            for (var index = 0; index < 5; index++)
            {
                ...
                cardInfo.CardNo = (cardIndex++).ToString();
            ...
            for (var index = 0; index < 5; index++)
            {
                ...
                employeeCardInfo.Employee.CardNo = employeeCardInfo.CardInfo.CardNo;
        ...
        private void smpSystemAttendanceOtherSub(string id, string sysNo)
        {
            ...
            {
                string indexChar = string.Format("{0}.", ((char)(index + 65)));
        ...
        public void TestGeneratorModuleInfo()
        {
            ...
            moduleService.Save(new DaoModel.Modules()
            {
                ActionKey = PermissionConstant.Billing_ProductRealtimeInfo,
                ActionName = "产线实时信息",
                Description = "产线实时信息",
                ModuleLevel = 2,
                ModulesType = (int)ModulesType.Page,
            ...
            moduleService.Save(new DaoModel.Modules()
            {
                ActionKey = PermissionConstant.Billing_ProductsingInfo,
                ActionName = "在制品信息",
                Description = "在制品信息",
                ModuleLevel = 2,
                ModulesType = (int)ModulesType.Page,
            ...
            moduleService.Save(new DaoModel.Modules()
            {
                ActionKey = PermissionConstant.Billing_CoatHanger,
                ActionName = "衣架信息",
                Description = "衣架信息",
                ModuleLevel = 2,
                ModulesType = (int)ModulesType.Page,
            ...
            {
                ActionKey = "barBtn_StatisticalReport",
                ActionName = "统计报表",
                Description = "统计报表",
                ModuleLevel = 1,
                ModulesType = (int)ModulesType.Button,
        ...
        #region 初始化多语言
        [TestMethod]
        public void TestGeneratorMultLanguage() {
            #region 主页
            //当前组别
            var CurrentWorkLine = new MulLanguage();
            CurrentWorkLine.ResKey = "CurrentWorkLine";
            CurrentWorkLine.ResType = 1;
            CurrentWorkLine.SimplifiedChinese = "当前组别";
