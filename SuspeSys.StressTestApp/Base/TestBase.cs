...
namespace SuspeSys.StressTestApp.Base
{
    ...
    public class TestBase
    {
        ...
        public TestBase()
        {
            ...
            log.Info("---------------------------Init Redis Begin-------------------------------------------->>>>");
            NewSusRedisClient.Instance.Init(false);
            log.Info("<<<<---------------------------Init Redis End--------------------------------------------");
            log.Info("---------------------------Init DaoFactory Begin-------------------------------------------->>>>");
            //TcpBootstrap.Instance.RegsiterRemotingByCode(null, false, null);
            SuspeApplication.Init(null, false);
            log.Info("<<<<---------------------------Init DaoFactory End--------------------------------------------");

            if (isOpenTcp)
            {
                log.Info("---------------Tcp Client Init-------------------------------->>>>");
                InitClient();
