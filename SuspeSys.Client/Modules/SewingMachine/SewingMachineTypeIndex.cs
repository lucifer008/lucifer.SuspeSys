...
namespace SuspeSys.Client.Modules.SewingMachine
{
    ...
    /// 衣车类别
    /// </summary>
    public partial class SewingMachineTypeIndex : Ext.CRUDControl
    {
        public SewingMachineTypeIndex()
        {
           // InitializeComponent();
           
        }
        public SewingMachineTypeIndex(XtraUserControl1 ucMain) : base(ucMain)
        {
            InitializeComponent();
        ...
        protected override void BindGridHeader(GridControl dataGrid)
        {
            ...
            gridView.Columns.AddRange(new DevExpress.XtraGrid.Columns.GridColumn[] {
                ...
                new DevExpress.XtraGrid.Columns.GridColumn() { Caption="类别代码",FieldName="Code",Visible=true,Name="TypeCode"},
                new DevExpress.XtraGrid.Columns.GridColumn() { Caption="类别名称",FieldName="Name",Visible=true,Name="TypeName"},
        ...
        {
            var dt = dataGrid.DataSource as IList<Domain.ClothingVehicleType>;
            if (null != dt)
            {
                dt.Add(new Domain.ClothingVehicleType());
            }
        ...
        protected override void Query(int currentPageIndex, SusGrid susGrid1, SearchControl searchControl)
        {
            ...
            var list = _action.GetClothingVehicleTypeAllList(currentPageIndex, pageSize, out totalCount, ordercondition, searchControl.Text.Trim());
        ...
        protected override void Save(GridControl dataGrid)
        {
            ...
            var list = base.GetModifiedRow<Domain.ClothingVehicleType>();
            ...
            if (null != list)
            {
                ...
                {
                    var t = m.TransformTo<Domain.ClothingVehicleType>();

                    if (!string.IsNullOrEmpty(m.Id))
                    {

                        action.Update<Domain.ClothingVehicleType>(t);

                    }
                    else
                    {

                        action.Save<Domain.ClothingVehicleType>(t);
        ...
        {
            var selectData = (((ColumnView)dataGrid.MainView).GetFocusedRow() as Domain.ClothingVehicleType).TransformTo<Domain.ClothingVehicleType>();
            ...
            {
                var action = new CommonAction();
                action.PhysicsDelte<Domain.ClothingVehicleType>(selectData.Id);
                base.Query(1);
            }
