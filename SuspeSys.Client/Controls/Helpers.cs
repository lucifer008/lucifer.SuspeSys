...
namespace DevExpress.DevAV
{
    ...
    static class AppHelper
    {
        ...
        {
            get {
                return DevExpress.Utils.ResourceImageHelper.CreateIconFromResourcesEx("SuspeSys.Client.Resources.AppIcon.ico", typeof(frmMain).Assembly);
            }
        }
        static Image img;
        ...
        {
            get { return (wRef != null) ? wRef.Target as frmMain : null; }
            set { wRef = new WeakReference(value); }
        }
    ...
    static class EditorHelpers
    {
        ...
        static ImageCollection CreatePersonPrefixImageCollection()
        {
            ...
            ret.AddImage(SuspeSys.Client.Properties.Resources.Doctor);
            ret.AddImage(SuspeSys.Client.Properties.Resources.Mr);
            ret.AddImage(SuspeSys.Client.Properties.Resources.Ms);
            ret.AddImage(SuspeSys.Client.Properties.Resources.Miss);
            ret.AddImage(SuspeSys.Client.Properties.Resources.Mrs);
            return ret;
        }
        static ImageCollection CreateTaskPriorityImageCollection()
        {
            ImageCollection ret = new ImageCollection();
            ret.ImageSize = new Size(16, 16);
            ret.AddImage(SuspeSys.Client.Properties.Resources.LowPriority);
            ret.AddImage(SuspeSys.Client.Properties.Resources.NormalPriority);
            ret.AddImage(SuspeSys.Client.Properties.Resources.MediumPriority);
            ret.AddImage(SuspeSys.Client.Properties.Resources.HighPriority);
            return ret;
        }
        ...
        static ImageCollection CreateBingManeuverTypeImageCollection()
        {
            ...
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_A_32);
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_arrow_left_32);
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_arrow_right_32);
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_B_32);
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_arrow_uturn_32);
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_arrow_bear_left_32);
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_arrow_bear_right_32);
            ret.AddImage(SuspeSys.Client.Properties.Resources.icon_arrow_forward_32);
            return ret;
        }
    ...
    class DemoStartUp : IObserver<string>
    {
        ...
        void IObserver<string>.OnNext(string status)
        {
            ...
            {
                XtraSplashScreen.SplashScreenManager.ShowDefaultSplashScreen(AppHelper.MainForm, true, true, "XXXXXX", status);
            }
            else
            {
