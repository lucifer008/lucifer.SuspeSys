...
{
    [TestClass]
    public class MonitorUploadTest : TestBase
    {
        ...
        public void TestPreareAllBridgeStatingNonCarryFlowAndUploadReworkFlowForRework(string hangerNo)
        {
            ...
            log.Info("-----------------------返工上传---------------------------------------");
            var reu = new ReworkDecodeUploadUnitCompanyTest(log);
            reu.TestReworkDecodeUpload("2", "5", hangerNo, "2");
            Thread.CurrentThread.Join(10000);
            outSiteAdapterTests.SearchProductRealtimeInfoTest("A");
            outSiteAdapterTests.SearchProductRealtimeInfoTest("B");
            outSiteAdapterTests.SeachHangerInfo(hangerNo);
            ...
            log.Info("-----------------------返工上传---------------------------------------");
            //var reu = new ReworkDecodeUploadUnitCompanyTest(log);
            reu.TestReworkDecodeUpload("1", "5", hangerNo, "4");
        ...
        public void TestTestPreareAllBridgeStatingNonCarryFlowAndUploadReworkFlowForRework() {
            TestPreareAllBridgeStatingNonCarryFlowAndUploadReworkFlowForRework("225");
        }
