...
namespace SuspeSys.CoreTest
{
    ...
    public class OutSiteAdapterTests : TestBase
    {
        ...
        private void HangerComeInStating()
        {
            //衣架进站回应
            var data = string.Format("{0} {1} 02 FF 00 50 00 {2}", HexHelper.TenToHexString2Len(mainTrackNumber1), HexHelper.TenToHexString2Len(9), string.Format("{0}", HexHelper.TenToHexString10Len(hangerNo)));
